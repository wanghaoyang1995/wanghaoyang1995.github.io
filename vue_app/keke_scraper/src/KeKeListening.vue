...
const on_help = () => {
  ...
  ElMessageBox.confirm(
    ...
    "<p>由于用了站外接口，需要安装<a href='https://microsoftedge.microsoft.com/addons/detail/cors-unblock/hkjklmhkbkdhlgnnfbbcihcajofmjgbh?hl=zh-CN'>CORS Unblock</a>(<strong>并启用!</strong>)插件才可正常使用，否则会报跨域错误。电脑端可用Chrome/Edge浏览器打开，手机端请使用firefox浏览器并安装`CORS Unblock`插件使用。</p>" +
